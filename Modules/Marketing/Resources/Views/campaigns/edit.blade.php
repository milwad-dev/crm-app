...
@section('content')
    <div class="content-wrapper container-xxl p-0">
        <x-panel-breadcrumb title="Edit {{ $editCampagin->name }} Campaign">
            ...
            <section id="flatpickr">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('campaigns.update', $editCampagin->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-1">
                                                ...
                                                <x-panel-input type="number" name="count_email_readed" id="count_email_readed"
                                                 placeholder="Enter Count Email Readed" value="{{ $editCampagin->count_email_readed }}" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-1">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-1">
                                                ...
                                                placeholder="Enter Real Cost" value="{{ $editCampagin->real_cost }}" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-1">
                                                ...
                                                placeholder="Enter Expected Income" value="{{ $editCampagin->expected_income }}" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-1">
                                                ...
                                                placeholder="Enter Expected Cost" value="{{ $editCampagin->expected_cost }}" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-1">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <x-panel-select id="status" name="status" defaultText="Select Your Status">
                                                    @foreach (\Modules\Marketing\Models\Campaign::$statuses as $status)
                                                        <option @if($editCampagin->status == $status) selected @endif
                                                            value="{{ $status }}">{{ $status }}
                                                        </option>
                                                    @endforeach
                                                </x-panel-select>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <x-panel-select id="type" name="type" defaultText="Select Your Type">
                                                    @foreach (\Modules\Marketing\Models\Campaign::$types as $type)
                                                        <option @if($editCampagin->type == $type) selected @endif
                                                            value="{{ $type }}">{{ $type }}
                                                        </option>
                                                    @endforeach
                                                </x-panel-select>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <x-panel-select id="type_money" name="type_money" defaultText="Select Your Type Money">
                                                    @foreach (\Modules\Marketing\Models\Campaign::$type_moneies as $type_money)
                                                        <option @if($editCampagin->type_money == $type_money) selected @endif
                                                            value="{{ $type_money }}">{{ $type_money }}
                                                        </option>
                                                    @endforeach
                                                </x-panel-select>
                                            </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <x-panel-select id="answer" name="answer" defaultText="Select Your Answer">
                                                    @foreach (\Modules\Marketing\Models\Campaign::$answers as $answer)
                                                        <option @if($editCampagin->answer == $answer) selected @endif
                                                            value="{{ $answer }}">{{ $answer }}
                                                        </option>
                                                    @endforeach
                                                </x-panel-select>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <x-panel-select id="campaign_id" name="campaign_id" defaultText="Select Your Mother Campaign">
                                                    @foreach ($campaigns as $campaign)
                                                        <option @if($editCampagin->campaign_id == $campaign->id) selected @endif
                                        ...
                                        <div class="col-6">
                                            <div class="mb-1">
                                                ...
                                                value="{{ $editCampagin->description }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
