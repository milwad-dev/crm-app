                ...
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none">
                        <span class="user-name fw-bolder">{{ Str::limit(auth()->user()->name, 6) }}</span>
                        <span class="user-status">Admin</span>
{{--                        TODO CORRECT ROLE--}}
                    </div>
                    <span class="avatar">
                        {{--                        TODO CORRECT Image User--}}
                        <img class="round" src="{{ asset('panel/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar"
                        height="40" width="40">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="page-profile.html">
                        <i class="me-50" data-feather="user"></i> Ticket
                    </a>
                    <a class="dropdown-item" href="app-email.html">
                        <i class="me-50" data-feather="mail"></i> Inbox
                    </a>
                    <a class="dropdown-item" href="app-todo.html">
                        <i class="me-50" data-feather="check-square"></i> TODO
                    </a>
