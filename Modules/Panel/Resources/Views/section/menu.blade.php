...
{{--                        auth()->user()->hasPermissionTo(\Modules\RolePermissions\Models\Permission::PERMISSION_SUPER_ADMIN))--}}
                        @if (! is_null($sidebarItem['text']))
                            <li class=" navigation-header">
                                <span data-i18n="Apps &amp; Pages">{{ $sidebarItem['text'] }}</span>
                                <i data-feather="more-horizontal"></i>
                            </li>
                        @endif
                        <li class=" nav-item">
                            <a class="d-flex align-items-center" href="{{ $sidebarItem['url'] }}">
                                <i data-feather="{{ $sidebarItem['icon'] }}"></i>
                                <span class="menu-title text-truncate" data-i18n="Dashboards">{{ $sidebarItem['title'] }}</span>
                            </a>
                        </li>
{{--                @endif--}}
            @endforeach
